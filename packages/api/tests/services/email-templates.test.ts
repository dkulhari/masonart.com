...
describe('Email Templates', () => {
  ...
  describe('getOrderConfirmationTemplate', () => {
    ...
    it('should include view order link', () => {
      ...
      expect(template.html).toContain(`chobii.art/orders/${order.orderNumber}`);
    });
    ...
    it('should include chobii.art branding', () => {
      const order = createMockOrder();
      const template = getOrderConfirmationTemplate(order);

      expect(template.html).toContain('CHOBII.ART');
    });
  });
  ...
  describe('getDeliveredTemplate', () => {
    ...
    it('should include social sharing prompt', () => {
      ...
      expect(template.html).toContain('@chobiiart');
    });
  ...
  describe('HTML Structure', () => {
    ...
    it('should have footer with social links', () => {
      ...
      expect(template.html).toContain('instagram.com/chobiiart');
      expect(template.html).toContain('support@chobii.art');
    });
  });
