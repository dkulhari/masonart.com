...
const mockReview: ReviewData = {
  ...
  content: 'The print quality is amazing and the colors are vibrant. Exactly what I was looking for.',
  author: {
    id: 'user-1',
    name: 'John Doe',
    image: null,
...
const mockLongReview: ReviewData = {
  ...mockReview,
  id: 'review-2',
  content: 'This is a very long review content that should definitely be truncated when displayed on the page. '.repeat(10),
};
