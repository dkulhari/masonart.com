...
describe("ReviewForm Component", () => {
  ...
  describe("Form Validation", () => {
    ...
    it("enables submit when form is valid", () => {
      ...
      fireEvent.change(contentInput, {
        target: { value: "This is a great product, highly recommend!" },
      });
  ...
  describe("Form Interaction", () => {
    ...
    it("handles cancel button", () => {
      ...
      render(<ReviewForm productId="123" isAuthenticated onCancel={handleCancel} />);
  ...
  describe("Form Submission", () => {
    it("shows loading state during submission", async () => {
      ...
      render(<ReviewForm productId="123" isAuthenticated onSubmit={handleSubmit} />);
  ...
  describe("Modal Variant", () => {
    it("renders modal variant with close button", () => {
      const handleCancel = vi.fn();
      render(
        <ReviewForm productId="123" isAuthenticated variant="modal" onCancel={handleCancel} />
      );
  ...
  describe("Custom ClassName", () => {
    it("applies custom className", () => {
      const { container } = render(
        <ReviewForm productId="123" isAuthenticated className="custom-form" />
      );
