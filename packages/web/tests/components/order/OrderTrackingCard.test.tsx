...
const mockTrackingResponse: ShipmentTrackingResponse = {
  ...
  tracking: {
    ...
    steps: [
      { status: 'pending', label: 'Order Received', completed: true, timestamp: '2024-02-01T10:00:00Z' },
      { status: 'label_created', label: 'Shipping Label Created', completed: true, timestamp: null },
