...
import { ReturnStatusCard, STATUS_CONFIG, REASON_LABELS } from '~/components/returns/ReturnStatusCard'
...
describe('ReturnStatusCard Component', () => {
  ...
  describe('Expansion', () => {
    ...
    it('is expanded by default when defaultExpanded is true', () => {
      render(
        <ReturnStatusCard returnRequest={createMockReturn()} defaultExpanded />
      )
  ...
  describe('Reason Display', () => {
    it('shows reason label', () => {
      render(
        <ReturnStatusCard returnRequest={createMockReturn({ reason: 'defective' })} defaultExpanded />
      )
    ...
    it('shows reason details', () => {
      ...
      expect(screen.getByText('The product arrived with scratches on the surface.')).toBeInTheDocument()
    })
  })
  ...
  describe('Rejection Message', () => {
    it('shows rejection reason when rejected', () => {
      ...
      expect(screen.getByText('Item was used and does not meet return conditions.')).toBeInTheDocument()
    })
  })
