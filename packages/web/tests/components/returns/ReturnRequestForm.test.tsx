...
import {
  ...
  RETURN_REASONS,
  MIN_DETAILS_LENGTH,
} from "~/components/returns/ReturnRequestForm";
...
describe("ReturnRequestForm Component", () => {
  ...
  describe("Details Textarea", () => {
    it("renders reason details textarea", () => {
      ...
      expect(screen.getByPlaceholderText(/please provide specific details/i)).toBeInTheDocument();
    });
    ...
    it("shows character count when typing", () => {
      ...
      fireEvent.change(textarea, {
        target: { value: "This is a test reason with enough characters" },
      });
