...
export type AICreationStatus = "queued" | "processing" | "completed" | "failed" | "cancelled";

export type AIModerationStatus = "pending_review" | "approved" | "rejected" | "flagged";
...
function AICreationCard({ creation, compact = false, onDelete, onAddToCart }: AICreationCardProps) {
