...
import { Image as ImageIcon, Upload, X, Info, Loader2, AlertCircle } from "lucide-react";
    ...
    <div className={cn("flex flex-col gap-3", className)}>
        ...
        <div className="flex flex-col gap-3">
          ...
          {referenceImage && (
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-foreground">Style Influence</span>
      ...
      {!referenceImage && !displayError && (
        <div className="flex items-start gap-2 text-xs text-muted-foreground">
          ...
          <span>
            Upload an image to guide the AI. The generated result will be influenced by the
            reference.
          </span>
        </div>
      )}
