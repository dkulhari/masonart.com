    ...
    return (
      <div
        className={cn(
          ...
          isUrgent ? "border-amber-200 bg-amber-50" : "border-green-200 bg-green-50",
          className
        )}
      >
        <div
        ...
        <div className="flex-1">
          <p className={cn("font-medium", isUrgent ? "text-amber-800" : "text-green-800")}>
            {isUrgent ? "Return Window Closing Soon!" : "Eligible for Return"}
          </p>
          <p className={cn("mt-0.5 text-sm", isUrgent ? "text-amber-700" : "text-green-700")}>
