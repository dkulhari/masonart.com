...
function LoginPage() {
  ...
  const validatePhone = (phone: string): string | undefined => {
    ...
    const phoneDigits =
      cleaned.startsWith("91") && cleaned.length === 12 ? cleaned.slice(2) : cleaned;
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handlePhoneChange("phone", e.target.value.replace(/\D/g, "").slice(0, 10))
                      }
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handlePhoneChange("otp", e.target.value.replace(/\D/g, "").slice(0, 6))
                      }
