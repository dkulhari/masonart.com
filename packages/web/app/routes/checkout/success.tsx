/**
 * Order Confirmation (Success) Page - chobii.art E-commerce Platform
 *
...
export const Route = createFileRoute('/checkout/success')({
  ...
  head: () => ({
    meta: [
      { title: 'Order Confirmed | chobii.art' },
      {
        name: 'description',
        content: 'Your order has been placed successfully. Thank you for shopping with chobii.art.',
      },
