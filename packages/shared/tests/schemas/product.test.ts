...
describe('Product SEO Schema', () => {
  const validSEO = {
    ...
    canonicalUrl: 'https://chobii.art/products/ocean-waves-poster',
  };
...
describe('Update Product Input Schema', () => {
  it('should accept partial updates', () => {
    const partialUpdates = [{ title: 'New Title' }, { status: 'draft' as const }, { isFeatured: true }];
