...
test.describe("Orders Status Filtering", () => {
  ...
  test("should have status filter dropdown", async ({ page }) => {
    ...
    const statusFilter = page.locator(
      'select:has-text("All Status"), [data-testid="status-filter"]'
    );
  ...
  test("should have payment status filter dropdown", async ({ page }) => {
    ...
    const paymentFilter = page.locator(
      'select:has-text("All Payment"), [data-testid="payment-filter"]'
    );
...
test.describe("Orders Status Badges", () => {
  ...
  test("should display Processing status badge", async ({ page }) => {
    ...
    const badge = page
      .locator('table span:has-text("Processing"), [role="table"] span:has-text("Processing")')
      .first();
  ...
  test("should display Shipped status badge", async ({ page }) => {
    // Target badge in table, not dropdown options
    const badge = page
      .locator('table span:has-text("Shipped"), [role="table"] span:has-text("Shipped")')
      .first();
    await expect(badge).toBeVisible();
  });
  ...
  test("should display Delivered status badge", async ({ page }) => {
    // Target badge in table, not dropdown options
    const badge = page
      .locator('table span:has-text("Delivered"), [role="table"] span:has-text("Delivered")')
      .first();
    await expect(badge).toBeVisible();
  });
  ...
  test("should display Cancelled status badge", async ({ page }) => {
    // Target badge in table, not dropdown options
    const badge = page
      .locator('table span:has-text("Cancelled"), [role="table"] span:has-text("Cancelled")')
      .first();
    await expect(badge).toBeVisible();
  });
  ...
  test("should display Paid payment badge", async ({ page }) => {
    const badge = page
      .locator('table span:has-text("Paid"), [role="table"] span:has-text("Paid")')
      .first();
    await expect(badge).toBeVisible();
  });
  ...
  test("should display Pending payment badge", async ({ page }) => {
    const badge = page
      .locator('table span:has-text("Pending"), [role="table"] span:has-text("Pending")')
      .first();
    await expect(badge).toBeVisible();
  });
  ...
  test("should display Refunded payment badge", async ({ page }) => {
    const badge = page
      .locator('table span:has-text("Refunded"), [role="table"] span:has-text("Refunded")')
      .first();
    await expect(badge).toBeVisible();
  });
});
...
test.describe("Orders List Pagination", () => {
  ...
  test("should display pagination controls", async ({ page }) => {
    ...
    const paginationCss = page.locator(
...
test.describe("Order Detail Page", () => {
  ...
  test("should display back button", async ({ page }) => {
    ...
    const backButton = page
      .locator('main button:has(svg):not(.lg\\:hidden):not([aria-label*="menu" i])')
      .first();
...
test.describe("Status Update Modal", () => {
  ...
  test("should display Cancel button in modal", async ({ page }) => {
    ...
    const cancelBtn = page.locator(
      '[role="dialog"] button:has-text("Cancel"), .fixed.inset-0 button:has-text("Cancel")'
    );
...
test.describe("Shipping Update Modal", () => {
  ...
  test("should display carrier input", async ({ page }) => {
    ...
    const carrierInput = page
      .locator('[role="dialog"] input[placeholder*="Delhivery"], .fixed.inset-0 input')
      .first();
  ...
  test("should display tracking number input", async ({ page }) => {
    ...
    const trackingInput = page.locator(
      '[role="dialog"] input[placeholder*="Tracking"], .fixed.inset-0 input[placeholder*="Tracking"]'
    );
  ...
  test("should display estimated delivery date input", async ({ page }) => {
    ...
    const dateInput = page.locator(
      '[role="dialog"] input[type="date"], .fixed.inset-0 input[type="date"]'
    );
...
test.describe("Order Not Found", () => {
  ...
  test("should display Back to Orders button on not found", async ({ page }) => {
    ...
    const backButton = page.locator(
      'button:has-text("Back to Orders"), a:has-text("Back to Orders")'
    );
    await expect(backButton).toBeVisible();
  });
});
