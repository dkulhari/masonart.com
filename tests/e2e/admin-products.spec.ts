...
test.describe("Admin Products List Page", () => {
  ...
  test('should display "Add Product" button', async ({ page }) => {
    const addButton = page.locator(
      'a[href="/admin/products/new"]:has-text("Add Product"), button:has-text("Add Product")'
    );
  ...
  test("should display products table/grid", async ({ page }) => {
    ...
    const productItems = page.locator(
      '[data-testid="product-row"], .product-item, tr:has-text("TX-")'
    );
...
test.describe("Products List Pagination", () => {
  ...
  test("should navigate to previous page", async ({ page }) => {
    ...
    const prevButton = page.locator(
      'button:has-text("Previous"), a:has-text("Previous"), [aria-label="Previous page"]'
    );
...
test.describe("Products List Sorting", () => {
  ...
  test("should have sortable column headers", async ({ page }) => {
    ...
    const sortableHeader = page
      .locator('th[data-sortable], th button, [role="columnheader"]')
      .first();
...
test.describe("Create Product Page", () => {
  ...
  test("should display required field: Base Price", async ({ page }) => {
    ...
    const priceInput = page.locator(
      'input[name="basePrice"], #basePrice, [data-testid="price-input"]'
    );
  ...
  test("should display orientation selector", async ({ page }) => {
    ...
    const orientationSelect = page.locator(
      'select[name="orientation"], #orientation, [data-testid="orientation-select"]'
    );
  ...
  test("should display status selector", async ({ page }) => {
    ...
    const statusSelect = page.locator(
      'select[name="status"], #status, [data-testid="status-select"]'
    );
...
test.describe("Product Variants Management", () => {
  ...
  test("should display existing variants", async ({ page }) => {
    ...
    const variant = page
      .locator('input[placeholder*="12"], input')
      .filter({ hasText: /12x16/ })
      .first();
...
test.describe("Products Navigation", () => {
  ...
  test("should have breadcrumb navigation", async ({ page }) => {
    ...
    const breadcrumb = page.locator(
      'nav[aria-label="Breadcrumb"], .breadcrumb, a:has-text("Products")'
    );
...
test.describe("Product Status Badges", () => {
  ...
  test("should display active status with green badge", async ({ page }) => {
    const activeBadge = page.locator(
      '.bg-green-100:has-text("active"), .text-green-700:has-text("active"), [data-status="active"]'
    );
    await expect(activeBadge.first()).toBeVisible();
  });
  ...
  test("should display draft status with yellow/amber badge", async ({ page }) => {
    const draftBadge = page.locator(
      '.bg-yellow-100:has-text("draft"), .bg-amber-100:has-text("draft"), [data-status="draft"]'
    );
  ...
  test("should display archived status with gray badge", async ({ page }) => {
    const archivedBadge = page.locator(
      '.bg-gray-100:has-text("archived"), [data-status="archived"]'
    );
