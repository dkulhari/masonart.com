 ...
 *
 * Tests for the MasonArt saved addresses management page (/account/addresses).
 *
...
test.describe("Addresses Page - Authenticated", () => {
  ...
  test("should load addresses page", async ({ page }) => {
    ...
    const heading = page
      .locator("h1")
      .filter({ hasText: /Saved Addresses/i })
      .first();
  ...
  test("should open add address form when clicking Add Address", async ({ page }) => {
    ...
    const addButton = page
      .locator('button:has-text("Add Address"), button:has-text("Add Your First Address")')
      .first();
  ...
  test("should have back to account link", async ({ page }) => {
    ...
    const backLink = page
      ...
      .filter({ hasText: /Back to Account/i })
      .first();
...
test.describe("Addresses Page SEO", () => {
  ...
  test("should have page title", async ({ page }) => {
    ...
    await expect(page).toHaveTitle(/Saved Addresses.*MasonArt/);
  });
