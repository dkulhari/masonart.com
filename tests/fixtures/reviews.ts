...
export const mockReviews: Omit<Review, "id" | "createdAt" | "updatedAt">[] = [
  {
    ...
    content:
      "This poster exceeded my expectations. The print quality is excellent and the colors are vibrant. Highly recommend!",
    status: "approved",
    moderatorId: null,
    moderatorNotes: null,
  },
...
export const validReviewContent = {
  ...
  medium: {
    ...
    content:
      "The poster quality is excellent and the print is very detailed. The only issue was that the packaging could have been better - there were some minor scratches on the surface. Overall, still a good purchase.",
  },
  long: {
    rating: 5,
