...
export function createProduct(overrides?: Partial<Product>): Product {
  ...
  return {
    ...
    description:
      "A serene minimalist abstract representation of ocean waves in calming blue and beige tones. Perfect for creating a peaceful atmosphere in your living space.",
    basePrice: "1499.00",
    ...
    seoDescription:
      "Transform your space with this serene ocean waves abstract poster. Minimalist design in calming blue tones. Available in multiple sizes with frame options.",
    status: "active",
    featuredOrder: 1,
    createdAt: now,
    updatedAt: now,
