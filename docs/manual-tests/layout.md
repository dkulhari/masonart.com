...
## Overview
This document covers manual testing of the chobii.art root layout components:
...
**Description**: Verify chobii.art logo is displayed correctly
...
- "chobii.art. All rights reserved." text
...
**Expected Result**:
- Title: "chobii.art | Premium Posters & Frames"
...
**Expected Result**:
- theme-color present
- Value: #f97316 (chobii.art brand orange)
