...
## Overview
This document covers manual testing of the XML sitemap for the chobii.art e-commerce platform, including:
...
**Expected Result**:
- Home page URL: https://chobii.art/
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <sitemap>
    <loc>https://chobii.art/sitemap-products.xml</loc>
    <lastmod>2026-01-19</lastmod>
  </sitemap>
</sitemapindex>
```
