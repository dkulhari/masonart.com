...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call4.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
    ...
    deleteAnonymousUser: better_call4.StrictEndpoint<"/delete-anonymous-user", {
      method: "POST";
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call4.MiddlewareInputContext<better_call4.MiddlewareOptions>) => Promise<void>;
    }[];
  };
