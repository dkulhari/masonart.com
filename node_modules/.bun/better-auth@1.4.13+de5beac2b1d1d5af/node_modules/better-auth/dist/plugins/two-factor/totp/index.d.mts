...
declare const totp2fa: (options?: TOTPOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateTOTP: better_call748.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
        secret: z.ZodString;
      }, z.core.$strip>;
     ...
     */
    getTOTPURI: better_call748.StrictEndpoint<"/two-factor/get-totp-uri", {
      method: "POST";
      use: ((inputContext: better_call748.MiddlewareInputContext<better_call748.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyTOTP: better_call748.StrictEndpoint<"/two-factor/verify-totp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
