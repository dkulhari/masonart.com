...
import * as better_call808 from "better-call";

//#region src/plugins/organization/routes/crud-invites.d.ts
declare const createInvitation: <O extends OrganizationOptions>(option: O) => better_call808.StrictEndpoint<"/organization/invite-member", {
  method: "POST";
  requireHeaders: true;
  use: (((inputContext: better_call808.MiddlewareInputContext<better_call808.MiddlewareOptions>) => Promise<{
  ...
  }>) | ((inputContext: better_call808.MiddlewareInputContext<{
    use: ((inputContext: better_call808.MiddlewareInputContext<better_call808.MiddlewareOptions>) => Promise<{
      session: {
...
declare const acceptInvitation: <O extends OrganizationOptions>(options: O) => better_call808.StrictEndpoint<"/organization/accept-invitation", {
  method: "POST";
  body: z.ZodObject<{
...
declare const rejectInvitation: <O extends OrganizationOptions>(options: O) => better_call808.StrictEndpoint<"/organization/reject-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const cancelInvitation: <O extends OrganizationOptions>(options: O) => better_call808.StrictEndpoint<"/organization/cancel-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const getInvitation: <O extends OrganizationOptions>(options: O) => better_call808.StrictEndpoint<"/organization/get-invitation", {
  method: "GET";
  use: ((inputContext: better_call808.MiddlewareInputContext<better_call808.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const listInvitations: <O extends OrganizationOptions>(options: O) => better_call808.StrictEndpoint<"/organization/list-invitations", {
  method: "GET";
  requireHeaders: true;
  use: (((inputContext: better_call808.MiddlewareInputContext<better_call808.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
 ...
 */
declare const listUserInvitations: <O extends OrganizationOptions>(options: O) => better_call808.StrictEndpoint<"/organization/list-user-invitations", {
  method: "GET";
  use: ((inputContext: better_call808.MiddlewareInputContext<better_call808.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
