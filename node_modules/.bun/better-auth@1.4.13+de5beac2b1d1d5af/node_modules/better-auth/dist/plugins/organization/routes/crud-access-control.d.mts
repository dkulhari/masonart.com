...
declare const createOrgRole: <O extends OrganizationOptions>(options: O) => better_call914.StrictEndpoint<"/organization/create-role", {
  method: "POST";
  body: z.ZodObject<{
  ...
  requireHeaders: true;
  use: ((inputContext: better_call914.MiddlewareInputContext<{
    use: ((inputContext: better_call914.MiddlewareInputContext<better_call914.MiddlewareOptions>) => Promise<{
      session: {
...
declare const deleteOrgRole: <O extends OrganizationOptions>(options: O) => better_call914.StrictEndpoint<"/organization/delete-role", {
  method: "POST";
...
declare const listOrgRoles: <O extends OrganizationOptions>(options: O) => better_call914.StrictEndpoint<"/organization/list-roles", {
  method: "GET";
  requireHeaders: true;
  use: ((inputContext: better_call914.MiddlewareInputContext<{
    use: ((inputContext: better_call914.MiddlewareInputContext<better_call914.MiddlewareOptions>) => Promise<{
...
declare const getOrgRole: <O extends OrganizationOptions>(options: O) => better_call914.StrictEndpoint<"/organization/get-role", {
  method: "GET";
  requireHeaders: true;
  use: ((inputContext: better_call914.MiddlewareInputContext<{
    use: ((inputContext: better_call914.MiddlewareInputContext<better_call914.MiddlewareOptions>) => Promise<{
...
declare const updateOrgRole: <O extends OrganizationOptions>(options: O) => better_call914.StrictEndpoint<"/organization/update-role", {
  method: "POST";
  body: z.ZodIntersection<z.ZodObject<{
    organizationId: z.ZodOptional<z.ZodString>;
    data: z.ZodObject<{
