...
import * as _better_auth_core_db30 from "@better-auth/core/db";
import * as z from "zod";
import * as better_call713 from "better-call";
...
declare const createHasPermission: <O extends OrganizationOptions>(options: O) => better_call713.StrictEndpoint<"/organization/has-permission", {
  method: "POST";
  requireHeaders: true;
  ...
  use: ((inputContext: better_call713.MiddlewareInputContext<{
    use: ((inputContext: better_call713.MiddlewareInputContext<better_call713.MiddlewareOptions>) => Promise<{
      session: {
    ...
    session: {
      session: _better_auth_core_db30.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db30.User;
    };
  }>)[];
  metadata: {
    $Infer: {
