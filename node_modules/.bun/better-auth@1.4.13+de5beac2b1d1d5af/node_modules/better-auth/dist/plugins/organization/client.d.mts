...
import * as _better_fetch_fetch82 from "@better-fetch/fetch";
...
declare const organizationClient: <CO extends OrganizationClientOptions>(options?: CO | undefined) => {
  ...
  getActions: ($fetch: _better_fetch_fetch82.BetterFetch, _$store: _better_auth_core24.ClientStore, co: _better_auth_core24.BetterAuthClientOptions | undefined) => {
    $Infer: {
  ...
  getAtoms: ($fetch: _better_fetch_fetch82.BetterFetch) => {
    $listOrg: nanostores3.PreinitializedWritableAtom<boolean> & object;
    $activeOrgSignal: nanostores3.PreinitializedWritableAtom<boolean> & object;
    $activeMemberSignal: nanostores3.PreinitializedWritableAtom<boolean> & object;
    $activeMemberRoleSignal: nanostores3.PreinitializedWritableAtom<boolean> & object;
