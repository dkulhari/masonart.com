...
import * as _better_auth_core_db99 from "@better-auth/core/db";
import * as z from "zod";
import * as better_call844 from "better-call";

//#region src/plugins/organization/routes/crud-members.d.ts
declare const addMember: <O extends OrganizationOptions>(option: O) => better_call844.StrictEndpoint<string, {
  method: "POST";
  body: z.ZodObject<{
  ...
  use: ((inputContext: better_call844.MiddlewareInputContext<better_call844.MiddlewareOptions>) => Promise<{
    ...
    getSession: (context: _better_auth_core59.GenericEndpointContext) => Promise<{
      session: _better_auth_core_db99.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db99.User;
    }>;
  }>)[];
  metadata: {
    $Infer: {
...
declare const removeMember: <O extends OrganizationOptions>(options: O) => better_call844.StrictEndpoint<"/organization/remove-member", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call844.MiddlewareInputContext<{
    use: ((inputContext: better_call844.MiddlewareInputContext<better_call844.MiddlewareOptions>) => Promise<{
      session: {
...
declare const updateMemberRole: <O extends OrganizationOptions>(option: O) => better_call844.StrictEndpoint<"/organization/update-member-role", {
  method: "POST";
  body: z.ZodObject<{
    role: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
...
declare const getActiveMember: <O extends OrganizationOptions>(options: O) => better_call844.StrictEndpoint<"/organization/get-active-member", {
  method: "GET";
  use: (((inputContext: better_call844.MiddlewareInputContext<better_call844.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const leaveOrganization: <O extends OrganizationOptions>(options: O) => better_call844.StrictEndpoint<"/organization/leave", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call844.MiddlewareInputContext<better_call844.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
...
declare const listMembers: <O extends OrganizationOptions>(options: O) => better_call844.StrictEndpoint<"/organization/list-members", {
  method: "GET";
...
declare const getActiveMemberRole: <O extends OrganizationOptions>(options: O) => better_call844.StrictEndpoint<"/organization/get-active-member-role", {
  method: "GET";
  query: z.ZodOptional<z.ZodObject<{
