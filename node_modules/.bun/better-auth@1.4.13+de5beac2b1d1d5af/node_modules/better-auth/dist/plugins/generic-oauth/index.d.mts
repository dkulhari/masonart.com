...
declare const genericOAuth: (options: GenericOAuthOptions) => {
  ...
  endpoints: {
    signInWithOAuth2: better_call32.StrictEndpoint<"/sign-in/oauth2", {
      method: "POST";
    ...
    oAuth2Callback: better_call32.StrictEndpoint<"/oauth2/callback/:providerId", {
      method: "GET";
    ...
    oAuth2LinkAccount: better_call32.StrictEndpoint<"/oauth2/link", {
      method: "POST";
      body: zod24.ZodObject<{
        providerId: zod24.ZodString;
