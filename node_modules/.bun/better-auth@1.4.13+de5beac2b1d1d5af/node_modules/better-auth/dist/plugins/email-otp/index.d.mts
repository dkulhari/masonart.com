...
declare const emailOTP: (options: EmailOTPOptions) => {
  ...
  endpoints: {
    sendVerificationOTP: better_call22.StrictEndpoint<"/email-otp/send-verification-otp", {
      method: "POST";
      body: zod0.ZodObject<{
    ...
    createVerificationOTP: better_call22.StrictEndpoint<string, {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodString;
        type: zod0.ZodEnum<{
    ...
    getVerificationOTP: better_call22.StrictEndpoint<string, {
      method: "GET";
    ...
    checkVerificationOTP: better_call22.StrictEndpoint<"/email-otp/check-verification-otp", {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodString;
        type: zod0.ZodEnum<{
    ...
    verifyEmailOTP: better_call22.StrictEndpoint<"/email-otp/verify-email", {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodString;
        otp: zod0.ZodString;
    ...
    signInEmailOTP: better_call22.StrictEndpoint<"/sign-in/email-otp", {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodString;
        otp: zod0.ZodString;
    ...
    forgetPasswordEmailOTP: better_call22.StrictEndpoint<"/forget-password/email-otp", {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    resetPasswordEmailOTP: better_call22.StrictEndpoint<"/email-otp/reset-password", {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodString;
        otp: zod0.ZodString;
