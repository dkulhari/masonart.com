...
import * as better_call251 from "better-call";
...
declare const oAuthProxy: <O extends OAuthProxyOptions>(opts?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    oAuthProxy: better_call251.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call251.MiddlewareInputContext<better_call251.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call251.MiddlewareInputContext<better_call251.MiddlewareOptions>) => Promise<void>;
    }[];
    after: {
      matcher(context: _better_auth_core19.HookEndpointContext): boolean;
      handler: (inputContext: better_call251.MiddlewareInputContext<better_call251.MiddlewareOptions>) => Promise<void>;
