...
import * as better_call245 from "better-call";
...
declare const username: (options?: UsernameOptions | undefined) => {
  ...
  endpoints: {
    signInUsername: better_call245.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call245.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
    ...
    user: {
      fields: {
        username: {
          ...
          returned: true;
          transform: {
            input(value: _better_auth_core_db5.DBPrimitive): string | number | boolean | Date | unknown[] | Record<string, unknown> | null | undefined;
          };
        };
        displayUsername: {
          type: "string";
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call245.MiddlewareInputContext<better_call245.MiddlewareOptions>) => Promise<void>;
    }[];
  };
