import * as _better_auth_core_db28 from "@better-auth/core/db";
  ...
  user: {
    fields: {
      username: {
        ...
        returned: true;
        transform: {
          input(value: _better_auth_core_db28.DBPrimitive): string | number | boolean | Date | unknown[] | Record<string, unknown> | null | undefined;
        };
      };
      displayUsername: {
        type: "string";
