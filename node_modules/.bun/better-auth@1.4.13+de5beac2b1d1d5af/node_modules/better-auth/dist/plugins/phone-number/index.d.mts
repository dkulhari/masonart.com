...
declare const phoneNumber: (options?: PhoneNumberOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call201.MiddlewareInputContext<better_call201.MiddlewareOptions>) => Promise<never>;
    }[];
  };
  endpoints: {
    signInPhoneNumber: better_call201.StrictEndpoint<"/sign-in/phone-number", {
      method: "POST";
    ...
    sendPhoneNumberOTP: better_call201.StrictEndpoint<"/phone-number/send-otp", {
      method: "POST";
      body: zod502.ZodObject<{
        phoneNumber: zod502.ZodString;
      }, zod_v4_core72.$strip>;
    ...
    verifyPhoneNumber: better_call201.StrictEndpoint<"/phone-number/verify", {
      method: "POST";
      body: zod502.ZodObject<{
        phoneNumber: zod502.ZodString;
    ...
    requestPasswordResetPhoneNumber: better_call201.StrictEndpoint<"/phone-number/request-password-reset", {
      method: "POST";
      body: zod502.ZodObject<{
        phoneNumber: zod502.ZodString;
      }, zod_v4_core72.$strip>;
    ...
    resetPasswordPhoneNumber: better_call201.StrictEndpoint<"/phone-number/reset-password", {
      method: "POST";
      body: zod502.ZodObject<{
