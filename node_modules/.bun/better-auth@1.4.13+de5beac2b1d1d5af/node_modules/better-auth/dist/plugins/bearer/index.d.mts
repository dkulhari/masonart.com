...
declare const bearer: (options?: BearerOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call10.MiddlewareInputContext<better_call10.MiddlewareOptions>) => Promise<{
        context: {
          headers: Headers;
        };
      } | undefined>;
    ...
    after: {
      ...
      handler: (inputContext: better_call10.MiddlewareInputContext<better_call10.MiddlewareOptions>) => Promise<void>;
    }[];
  };
