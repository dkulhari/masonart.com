...
declare const oneTapClient: (options: GoogleOneTapOptions) => {
  ...
  fetchPlugins: {
    ...
    name: string;
    hooks: {
      onResponse(ctx: _better_fetch_fetch79.ResponseContext): Promise<void>;
    };
  }[];
  getActions: ($fetch: _better_fetch_fetch79.BetterFetch, _: _better_auth_core23.ClientStore) => {
    oneTap: (opts?: GoogleOneTapActionOptions | undefined, fetchOptions?: ClientFetchOption | undefined) => Promise<void>;
  };
  getAtoms($fetch: _better_fetch_fetch79.BetterFetch): {};
};
//#endregion
