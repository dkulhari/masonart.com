...
import * as _better_auth_core30 from "@better-auth/core";
...
import * as zod1943 from "zod";
import * as better_call717 from "better-call";
import * as zod_v4_core279 from "zod/v4/core";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      matcher: (ctx: _better_auth_core30.HookEndpointContext) => boolean;
      handler: (inputContext: better_call717.MiddlewareInputContext<better_call717.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call717.MiddlewareContext<better_call717.MiddlewareOptions, {
          returned?: unknown | undefined;
          responseHeaders?: Headers | undefined;
        } & _better_auth_core30.PluginContext & _better_auth_core30.InfoContext & {
          options: _better_auth_core30.BetterAuthOptions;
          ...
          newSession: {
            session: _better_auth_core_db32.Session & Record<string, any>;
            user: _better_auth_core_db32.User & Record<string, any>;
          } | null;
          session: {
            session: _better_auth_core_db32.Session & Record<string, any>;
            user: _better_auth_core_db32.User & Record<string, any>;
          ...
          authCookies: _better_auth_core30.BetterAuthCookies;
          ...
          } & Omit<_better_auth_core30.BetterAuthRateLimitOptions, "enabled" | "window" | "max" | "storage">;
          adapter: _better_auth_core_db_adapter1.DBAdapter<_better_auth_core30.BetterAuthOptions>;
          internalAdapter: _better_auth_core30.InternalAdapter<_better_auth_core30.BetterAuthOptions>;
          createAuthCookie: (cookieName: string, overrideAttributes?: Partial<better_call717.CookieOptions> | undefined) => _better_auth_core30.BetterAuthCookie;
          secret: string;
          sessionConfig: {
            updateAge: number;
            expiresIn: number;
          ...
          generateId: (options: {
            model: _better_auth_core_db32.ModelNames;
            size?: number | undefined;
          }) => string | false;
          secondaryStorage: _better_auth_core_db32.SecondaryStorage | undefined;
          password: {
            ...
            checkPassword: (userId: string, ctx: _better_auth_core30.GenericEndpointContext<_better_auth_core30.BetterAuthOptions>) => Promise<boolean>;
          };
          tables: _better_auth_core_db32.BetterAuthDBSchema;
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call717.StrictEndpoint<"/api-key/create", {
      method: "POST";
      body: zod1943.ZodObject<{
        name: zod1943.ZodOptional<zod1943.ZodString>;
        expiresIn: zod1943.ZodDefault<zod1943.ZodNullable<zod1943.ZodOptional<zod1943.ZodNumber>>>;
        userId: zod1943.ZodOptional<zod1943.ZodCoercedString<unknown>>;
        prefix: zod1943.ZodOptional<zod1943.ZodString>;
        remaining: zod1943.ZodDefault<zod1943.ZodNullable<zod1943.ZodOptional<zod1943.ZodNumber>>>;
        metadata: zod1943.ZodOptional<zod1943.ZodAny>;
        refillAmount: zod1943.ZodOptional<zod1943.ZodNumber>;
        refillInterval: zod1943.ZodOptional<zod1943.ZodNumber>;
        rateLimitTimeWindow: zod1943.ZodOptional<zod1943.ZodNumber>;
        rateLimitMax: zod1943.ZodOptional<zod1943.ZodNumber>;
        rateLimitEnabled: zod1943.ZodOptional<zod1943.ZodBoolean>;
        permissions: zod1943.ZodOptional<zod1943.ZodRecord<zod1943.ZodString, zod1943.ZodArray<zod1943.ZodString>>>;
     ...
     */
    verifyApiKey: better_call717.StrictEndpoint<string, {
      method: "POST";
      body: zod1943.ZodObject<{
        key: zod1943.ZodString;
        permissions: zod1943.ZodOptional<zod1943.ZodRecord<zod1943.ZodString, zod1943.ZodArray<zod1943.ZodString>>>;
      }, zod_v4_core279.$strip>;
    }, {
      valid: boolean;
     ...
     */
    getApiKey: better_call717.StrictEndpoint<"/api-key/get", {
      method: "GET";
      query: zod1943.ZodObject<{
        id: zod1943.ZodString;
      }, zod_v4_core279.$strip>;
      use: ((inputContext: better_call717.MiddlewareInputContext<better_call717.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    updateApiKey: better_call717.StrictEndpoint<"/api-key/update", {
      method: "POST";
      body: zod1943.ZodObject<{
        keyId: zod1943.ZodString;
        userId: zod1943.ZodOptional<zod1943.ZodCoercedString<unknown>>;
        name: zod1943.ZodOptional<zod1943.ZodString>;
        enabled: zod1943.ZodOptional<zod1943.ZodBoolean>;
        remaining: zod1943.ZodOptional<zod1943.ZodNumber>;
        refillAmount: zod1943.ZodOptional<zod1943.ZodNumber>;
        refillInterval: zod1943.ZodOptional<zod1943.ZodNumber>;
        metadata: zod1943.ZodOptional<zod1943.ZodAny>;
        expiresIn: zod1943.ZodNullable<zod1943.ZodOptional<zod1943.ZodNumber>>;
        rateLimitEnabled: zod1943.ZodOptional<zod1943.ZodBoolean>;
        rateLimitTimeWindow: zod1943.ZodOptional<zod1943.ZodNumber>;
        rateLimitMax: zod1943.ZodOptional<zod1943.ZodNumber>;
        permissions: zod1943.ZodNullable<zod1943.ZodOptional<zod1943.ZodRecord<zod1943.ZodString, zod1943.ZodArray<zod1943.ZodString>>>>;
      }, zod_v4_core279.$strip>;
      metadata: {
        openapi: {
          description: string;
     ...
     */
    deleteApiKey: better_call717.StrictEndpoint<"/api-key/delete", {
      method: "POST";
      body: zod1943.ZodObject<{
        keyId: zod1943.ZodString;
      }, zod_v4_core279.$strip>;
     ...
     */
    listApiKeys: better_call717.StrictEndpoint<"/api-key/list", {
      method: "GET";
      use: ((inputContext: better_call717.MiddlewareInputContext<better_call717.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    deleteAllExpiredApiKeys: better_call717.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
    ...
    apikey: {
      fields: {
        ...
        metadata: {
          ...
          input: true;
          transform: {
            input(value: _better_auth_core_db32.DBPrimitive): string;
            output(value: _better_auth_core_db32.DBPrimitive): any;
          };
        };
      };
    };
