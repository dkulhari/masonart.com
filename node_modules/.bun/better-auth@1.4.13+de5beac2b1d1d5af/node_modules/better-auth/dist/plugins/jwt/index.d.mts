...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: better_call50.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call50.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call50.MiddlewareInputContext<better_call50.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call50.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call50.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
